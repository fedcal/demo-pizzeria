...
URL: `https://pizzeria.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `pizzeria.demo.federicocalo.dev`
...
- Output directory: `dist/pizzeria/browser`
...
Per usare `pizzeria-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   pizzeria-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `pizzeria-docs.federicocalo.dev`
