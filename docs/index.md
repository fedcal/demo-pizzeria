...
hero:
  ...
  actions:
    - theme: brand
      text: Demo live
      link: https://pizzeria.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-pizzeria
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Pizzeria.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Pizzeria** in Italia.
...
Il mercato italiano delle PMI per **Pizzeria** ha caratteristiche specifiche:
...
- [GitHub repo](https://github.com/fedcal/federico-demo-pizzeria)
