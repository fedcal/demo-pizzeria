    ...
    <header class="site-header">
      <div class="site-header__inner">
        <a routerLink="/" class="brand" aria-label="Home">
          ...
          <span class="brand__text">Da Mario</span>
        </a>
        <nav class="site-nav" aria-label="Navigazione principale">
          <a routerLink="/" routerLinkActive="is-active" [routerLinkActiveOptions]="{ exact: true }">Home</a>
          <a routerLink="/menu" routerLinkActive="is-active">Menu</a>
          <a routerLink="/chi-siamo" routerLinkActive="is-active">Chi siamo</a>
          <a routerLink="/galleria" routerLinkActive="is-active">Galleria</a>
          <a routerLink="/contatti" routerLinkActive="is-active" class="cta">Prenota</a>
        </nav>
      </div>
    </header>
  `,
